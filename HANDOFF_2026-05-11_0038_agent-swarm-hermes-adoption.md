...
**Status:** Decision frozen. Implementation deferred until single-model migration (HANDOFF_2026-05-09_0950) completes.
**Predecessor:** `HANDOFF_2026-05-09_0950_single-model-migration.md`
...
**This work begins ONLY after the single-model migration (M1-M12 from HANDOFF_2026-05-09_0950) is complete and verified.** Do not interleave.
...
- `HANDOFF_2026-05-09_0950_single-model-migration.md` (predecessor — must complete first)
